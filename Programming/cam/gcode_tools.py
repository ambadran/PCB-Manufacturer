...
def generate_ink_laying_gcode(gerber_file: str, tool: Callable, tip_thickness: float, pen_down_position: int, feedrate: int, terminate_after=True) -> str:
    '''
    :param gerber_file: the file that we want to get the holes coordinate from
    :param tool: The tool function defined inside the get_tool_func closure function, it generates gcode to select wanted tool
    ...
    ### G-Code to be generated ###
    gcode = '; This gcode is generated by my specialised python script for my PCB manufacturer project :))\n\n'
    gcode += '; The following gcode is the ink laying gcode'
    gcode += '; According to input gerber file it will have {num_ys} number of y iterations and Over-lapping distance is {overlapping_distance}'
