...
void soft_uart_send_ALL() {
    ...
    temp_value = OF_num_TMR1;

    third_digit = intToASCII(temp_value%10);
    temp_value = divu10(temp_value);
    second_digit = intToASCII(temp_value%10);
    temp_value = divu10(temp_value);
    first_digit = intToASCII(temp_value%10);
